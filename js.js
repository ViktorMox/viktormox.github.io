...
document.getElementById("negrik").style.display ="block";
  
document.getElementById("negrik+").style.display ="block";  
  
document.getElementById("ml_pidoras").style.display ="block";  
  
document.getElementById("pidoras").style.display ="block";  

document.getElementById("imperator").style.display ="block";  
